...
plotDir <- file.path(abideDir, "Plot/Cluster/Cluster_A/SpectralCluster/CorrRaw")
resDate <- "240315"
...
### 保存下来结果
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_statis_Corr_raw_L_", resDate, ".csv")
write.csv(L_sorted, file.path(statiDir, name), row.names = F)
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_statis_Corr_raw_H_", resDate, ".csv")
