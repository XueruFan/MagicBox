...
plotDir <- file.path(abideDir, "Plot/Cluster/Cluster_A/GmmCluster/GAMMlbcc")
resDate <- "240315"
...
for (volumeName in volumeNames){
  ...
  name <- paste0("abide_A_asd_male_dev_GMM_Cluster_", volumeName, "_GAMLSS_lbcc_", resDate,".png")
