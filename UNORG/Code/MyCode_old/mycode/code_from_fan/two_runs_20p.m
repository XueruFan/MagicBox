...
for visit = 1:2;
    ...
    for rest = 1:2;
        ...
        for step = 1:10;
            ...
            filename = strcat([filefolder,'/zSFC/S',num2str(step),'_R',num2str(rest),...
...
for s = 1:10;
    ...
    filefolder = strcat([filefolder_sfc,'/zSFC/nii/']);
...
for step = 1:10;
    ...
    filename = strcat([filefolder,'/zSFC/2r/for_cal_icc_S',num2str(step),'.mat']);
...
for s = 1:10;  
    ...
    a.dscalar = vl_icc;
    ft_write_cifti(strcat([filefolder,'/zSFC/2r/nii/vl_icc_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = vl_sub2;
    ft_write_cifti(strcat([filefolder,'/zSFC/2r/nii/vl_sub2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = vl_sub_vis2;
    ft_write_cifti(strcat([filefolder,'/zSFC/2r/nii/vl_sub_vis2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = vl_err2;
    ft_write_cifti(strcat([filefolder,'/zSFC/2r/nii/vl_err2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');
    
    a.dscalar = al_icc;
    ft_write_cifti(strcat([filefolder,'/zSFC/2r/nii/al_icc_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = al_sub2;
    ft_write_cifti(strcat([filefolder,'/zSFC/2r/nii/al_sub2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = al_sub_vis2;
    ft_write_cifti(strcat([filefolder,'/zSFC/2r/nii/al_sub_vis2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = al_err2;
    ft_write_cifti(strcat([filefolder,'/zSFC/2r/nii/al_err2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = sl_icc;
    ft_write_cifti(strcat([filefolder,'/zSFC/2r/nii/sl_icc_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = sl_sub2;
    ft_write_cifti(strcat([filefolder,'/zSFC/2r/nii/sl_sub2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = sl_sub_vis2;
    ft_write_cifti(strcat([filefolder,'/zSFC/2r/nii/sl_sub_vis2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = sl_err2;
    ft_write_cifti(strcat([filefolder,'/zSFC/2r/nii/sl_err2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');
