...
for visit = 1:2;
    ...
    for rest = 1:2;
        ...
        for step = 1:10;
            ...
            filename = strcat([filefolder,'/zSFC/1r/S',num2str(step),'_R',num2str(rest),...
...
filefolder = strcat(['/Users/fanxueru/Library/Mobile Documents/'...
    'com~apple~CloudDocs/project/hcp/MasterProject/'...
    'HCP_2visits_400ptseries/zSFC/1r']);
...
for s = 1:10;
    ...
    cd (strcat([filefolder_sfc,'/zSFC/1r']))
    ...
    filefolder = strcat([filefolder_sfc,'/zSFC/1r/nii/']);
...
for step = 1:10;
    ...
    filename = strcat([filefolder,'/zSFC/1r/for_cal_icc_S',num2str(step),'.mat']);
...
for s = 1:10;  
    ...
    a.dscalar = vl_icc;
    ft_write_cifti(strcat([filefolder,'/zSFC/1r/nii/vl_icc_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = vl_sub2;
    ft_write_cifti(strcat([filefolder,'/zSFC/1r/nii/vl_sub2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = vl_sub_vis2;
    ft_write_cifti(strcat([filefolder,'/zSFC/1r/nii/vl_sub_vis2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = vl_err2;
    ft_write_cifti(strcat([filefolder,'/zSFC/1r/nii/vl_err2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');
    
    a.dscalar = al_icc;
    ft_write_cifti(strcat([filefolder,'/zSFC/1r/nii/al_icc_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = al_sub2;
    ft_write_cifti(strcat([filefolder,'/zSFC/1r/nii/al_sub2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = al_sub_vis2;
    ft_write_cifti(strcat([filefolder,'/zSFC/1r/nii/al_sub_vis2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = al_err2;
    ft_write_cifti(strcat([filefolder,'/zSFC/1r/nii/al_err2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');

    a.dscalar = sl_icc;
    ft_write_cifti(strcat([filefolder,'/zSFC/1r/nii/sl_icc_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');
    ...
    a.dscalar = sl_err2;
    ft_write_cifti(strcat([filefolder,'/zSFC/1r/nii/sl_err2_LTs',num2str(s),...
        '.nii']),a,'parameter','dscalar');
